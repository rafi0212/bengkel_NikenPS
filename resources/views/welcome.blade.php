...
<body class="bg-gray-50 font-sans text-gray-800">
    ...
    <nav class="bg-white shadow-lg py-4">
        <div class="container mx-auto flex justify-between items-center">
            ...
            <ul class="flex space-x-6 items-center hidden md:flex">
            ...
            <div class="md:hidden">
                <button id="hamburger" class="text-2xl text-yellow-600" onclick="toggleMenu()">&#9776;</button>
            </div>
        </div>

        <!-- Mobile Menu -->
        <div id="mobileMenu" class="md:hidden hidden bg-white shadow-lg py-4">
            <ul class="flex flex-col items-center">
                <li><a href="#services" class="text-lg hover:text-yellow-600 transition py-2">Services</a></li>
                <li><a href="#about" class="text-lg hover:text-yellow-600 transition py-2">About</a></li>
                <li><a href="#contact" class="text-lg hover:text-yellow-600 transition py-2">Contact</a></li>
                @if (Route::has('login'))
                    <li class="flex items-center space-x-4 py-2">
                        @auth
                            <a href="{{ url('/Kasir/transaksiread') }}" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">Home</a>
                        @else
                            <a href="{{ route('login') }}" class="bg-yellow-600 text-white py-2 px-4 rounded-lg hover:bg-yellow-700 transition">Log in</a>
                        @endauth
                    </li>
